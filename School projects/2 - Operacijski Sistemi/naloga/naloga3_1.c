...
ukaz ukazi[ST_UKAZOV] = {
    ...
    {"pid", &pid, "Izpis PID procesa lupine"},
    {"ppid", &ppid, "Izpis PID starševskega procesa lupine."},
    {"uid", &uid, "Izpis UID uporabnika, ki je lastnik procesa lupine"},
    {"euid", &euid, "Izpis UID uporabnika, ki je aktualni lastnik procesa lupine"},
    {"gid", &gid, "Izpis GID skupine, kateri pripada proces lupine"},
    {"egid", &egid, "Izpis GID skupine, kateri aktualno pripada proces lupine"},
    {"sysinfo", &sysinfo, "Izpiše osnovne informacije v sistemu."},
};
